            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form action="{{route('addMoneyToDB')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="cnumber" class="form-control select2" style="width: 100%;">
                                                @foreach($client as $c)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select required name="mtype"class="form-control">
                                                <option selected disabled>Select Money Type</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>Amount</td>
                                        <td>
                                            <input type="number" required name="amount" class="form-control" value="" autocomplete="off" id="exampleInputEmail1">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>1.</td>
